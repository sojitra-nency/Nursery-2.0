...
const documents = [
  ...
  // ── Mango ─────────────────────────────────────────────────────────────────
  {
    ...
    careTips: {
      ...
      gu: "ઉનાળામાં અઠવાડિયે બે વાર, બાકીની ઋતુમાં એક વાર ઊંડું પાણી આપો. ફૂલ આવતાં પહેલાં પોટાશવાળું ખાતર આપો. પાણી ભરાવા ન દો. કલમી છોડ 2–3 વર્ષે ફળ આપે છે.",
    },
    tags: ["fruit", "grafted"],
    varieties: [
      variety({
        ...
        watering: "medium",
        growthRate: "medium",
        sizeRange: "1.5–2 ft (grafted sapling)",
        bloomSeason: "February–March",
        maxHeight: "10–15 m",
        bagSizes: [
          bagSize("10 × 10", [
            [1, 10, 380],
  ...
  // ── Snake Plant ───────────────────────────────────────────────────────────
  {
    ...
    description: {
      ...
      gu: "શ્રેષ્ઠ હવા શુદ્ધ કરતા છોડમાંનો એક. ઓછા પ્રકાશ અને ઓછા પાણીમાં પણ ટકી રહે છે. પાનની જુદી જુદી ભાતવાળી જાતો મળે છે.",
    },
    ...
    careTips: {
      ...
      gu: "માટીના ઉપરના 2 ઇંચ સાવ સુકાય પછી જ પાણી આપો. મહિને એક વાર પાન લૂછો. ભરાયેલા પાણીમાં કદી ન રાખો — મૂળ સડવાનું મુખ્ય જોખમ છે.",
    },
    tags: ["air-purifying", "low-maintenance", "beginner"],
    varieties: [
      variety({
        name: { en: "Laurentii", hi: "लॉरेंटी", gu: "લોરેન્ટી" },
        availability: "in_stock",
        sunlight: "shade",
        watering: "low",
        growthRate: "slow",
      ...
      variety({
        name: { en: "Moonshine", hi: "मूनशाइन", gu: "મૂનશાઇન" },
        availability: "in_stock",
        sunlight: "shade",
        watering: "low",
        growthRate: "slow",
      ...
      variety({
        name: { en: "Zeylanica", hi: "ज़ेलानिका", gu: "ઝેલાનિકા" },
        availability: "in_stock",
        sunlight: "shade",
        watering: "low",
        growthRate: "slow",
      ...
      variety({
        name: { en: "Black Coral", hi: "ब्लैक कोरल", gu: "બ્લેક કોરલ" },
        availability: "limited",
        sunlight: "shade",
        watering: "low",
        growthRate: "slow",
  ...
  // ── Money Plant ───────────────────────────────────────────────────────────
  {
    ...
    description: {
      ...
      gu: "સૌભાગ્ય અને સમૃદ્ધિ લાવનારો પ્રિય વેલો. પાણીમાં કે માટીમાં, ઘરની અંદર કે બહાર — ગમે ત્યાં ઊગે છે. પાનની અનેક ભાત મળે છે.",
    },
    ...
    varieties: [
      variety({
        name: { en: "Golden Pothos", hi: "गोल्डन पोथोस", gu: "ગોલ્ડન પોથોસ" },
        availability: "in_stock",
      ...
      variety({
        name: { en: "Marble Queen", hi: "मार्बल क्वीन", gu: "માર્બલ ક્વીન" },
        availability: "in_stock",
        sunlight: "bright_indirect",
        watering: "medium",
        growthRate: "medium",
      ...
      variety({
        name: { en: "Neon Pothos", hi: "नियॉन पोथोस", gu: "નિયોન પોથોસ" },
        availability: "in_stock",
        sunlight: "bright_indirect",
        watering: "medium",
        growthRate: "fast",
  ...
  // ── Aloe Vera ─────────────────────────────────────────────────────────────
  {
    ...
    description: {
      ...
      gu: "ઉત્તમ ઔષધીય ઘરેલું છોડ. ત્વચા અને વાળ માટે રાહત આપતું જેલ. ઉગાડવામાં સહેલો, મરવો લગભગ અશક્ય.",
    },
    ...
    careTips: {
      ...
      gu: "દર 2–3 અઠવાડિયે પાણી આપો. બે વખત પાણી આપવા વચ્ચે માટી સાવ સુકાવા દો. સકુલન્ટ/કેક્ટસ મિક્સ વાપરો. વધુ પાણી ન આપો — મરવાનું મુખ્ય કારણ એ જ છે.",
    },
    tags: ["medicinal", "succulent", "beginner"],
    varieties: [
      variety({
        name: { en: "Barbadensis (Common Aloe)", hi: "बारबाडेंसिस", gu: "બારબાડેન્સિસ" },
        availability: "in_stock",
        sunlight: "full_sun",
        watering: "low",
        growthRate: "slow",
      ...
      variety({
        name: { en: "Chinensis (Chinese Aloe)", hi: "चिनेंसिस", gu: "ચિનેન્સિસ" },
        availability: "in_stock",
        sunlight: "full_sun",
        watering: "low",
        growthRate: "slow",
  ...
  // ── Jade Plant ────────────────────────────────────────────────────────────
  {
    ...
    description: {
      ...
      gu: "'મની ટ્રી' તરીકે ઓળખાતો લાંબું જીવતો સકુલન્ટ. લાકડા જેવી ડાળી પર લંબગોળ જેડ-લીલાં પાન. ઓછી સંભાળમાં દાયકાઓ સુધી જીવે છે.",
    },
    ...
    varieties: [
      variety({
        name: { en: "Ovata (Common Jade)", hi: "ओवाटा", gu: "ઓવાટા" },
        availability: "in_stock",
        sunlight: "bright_indirect",
        watering: "low",
        growthRate: "slow",
      ...
      variety({
        name: { en: "Gollum (Trumpet Jade)", hi: "गोलम", gu: "ગોલમ" },
        availability: "in_stock",
        sunlight: "bright_indirect",
        watering: "low",
        growthRate: "slow",
